...
namespace FrostweepGames.Plugins.Native
{
	public sealed class CustomMicrophone
	{
		...
		public static void RequestMicrophonePermission()
		{
			...
			{
#if UNITY_ANDROID
				var result = AndroidRuntimePermissions.RequestPermission(UnityEngine.Android.Permission.Microphone);
				Debug.Log(result);
				//UnityEngine.Android.PermissionCallbacks permissionCallbacks = new UnityEngine.Android.PermissionCallbacks();
				//permissionCallbacks.PermissionGranted += (value) => { Debug.Log(value); };
				//permissionCallbacks.PermissionDenied += (value) => { Debug.Log(value); };
				//permissionCallbacks.PermissionDeniedAndDontAskAgain += (value) => { Debug.Log(value); };
		...
		{
#if UNITY_ANDROID
			return AndroidRuntimePermissions.CheckPermission(UnityEngine.Android.Permission.Microphone) == AndroidRuntimePermissions.Permission.Granted;
